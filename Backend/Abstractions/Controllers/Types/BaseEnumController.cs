...
public abstract class BaseEnumController<T>(DatabaseContext context) : BaseODataController<T>(context) where T : class, ITypeEnum {
	...
	public virtual ActionResult<SingleResult<T>> Get([FromRoute] byte key) {
