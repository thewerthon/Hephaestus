...
public abstract class BaseBoolController<T>(DatabaseContext context) : BaseODataController<T>(context) where T : class, ITypeBool {
	...
	public virtual ActionResult<SingleResult<T>> Get([FromRoute] bool key) {
